...
var numberOfSlices = slicesOfPizza;
numberOfSlices*=pizzaOrdered;
...
var numberOfSlicePerPerson = numberOfSlices;
numberOfSlicePerPerson/= numberOfPeople;
...
discountPercentages/=100
var discountPrice = originalPrice - originalPrice * discountPercentages;

//Price of the item with tax
//equals discountPrice + discountPrice * (saleTaxPer/100)
saleTaxPer/=100
var  taxPrice= discountPrice + discountPrice * saleTaxPer;
